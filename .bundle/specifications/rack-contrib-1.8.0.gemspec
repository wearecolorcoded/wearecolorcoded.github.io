# -*- encoding: utf-8 -*-
# stub: rack-contrib 1.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<i18n>.freeze, ["~> 0.5", ">= 0.5.2"])
      s.add_development_dependency(%q<json>.freeze, ["~> 1.8", ">= 1.8.5"])
      ...
      s.add_dependency(%q<i18n>.freeze, ["~> 0.5", ">= 0.5.2"])
      s.add_dependency(%q<json>.freeze, ["~> 1.8", ">= 1.8.5"])
